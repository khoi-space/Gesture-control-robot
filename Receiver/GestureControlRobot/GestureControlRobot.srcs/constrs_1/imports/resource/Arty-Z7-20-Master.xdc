...
set_property PULLUP true [get_ports { nrf_irq }]
...
#set_property -dict { PACKAGE_PIN Y17    IOSTANDARD LVCMOS33 } [get_ports { motor_dir[1] }]; #IO_L7N_T1_34 Sch=JA2_N (Pin 4)
#set_property -dict { PACKAGE_PIN U18    IOSTANDARD LVCMOS33 } [get_ports { motor_dir[2] }]; #IO_L12P_T1_MRCC_34 Sch=JA3_P (Pin 7)
#set_property -dict { PACKAGE_PIN U19    IOSTANDARD LVCMOS33 } [get_ports { motor_dir[3] }]; #IO_L12N_T1_MRCC_34 Sch=JA3_N (Pin 8)
...
#set_property -dict { PACKAGE_PIN T10    IOSTANDARD LVCMOS33 } [get_ports { nrf_mosi }]; #IO_L1N_T0_34 Sch=JB2_N (Pin 4)
#set_property -dict { PACKAGE_PIN V16    IOSTANDARD LVCMOS33 } [get_ports { nrf_miso }]; #IO_L18P_T2_34 Sch=JB3_P (Pin 7)
